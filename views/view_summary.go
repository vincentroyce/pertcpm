...
func ViewSummaryHandler(w http.ResponseWriter, r *http.Request) map[string]interface{} {
	...
	uadmin.Filter(&workers, "project_id = ?", project.ID)

	equipments := []models.Equipment{}
	uadmin.Filter(&equipments, "project_id = ?", project.ID)
